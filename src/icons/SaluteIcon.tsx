...
export type SaluteIconProps = {
  className?: string;
};

function SaluteIcon({ className = '' }: SaluteIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M46.629,1.669c-0.932-0.929-2.438-0.929-3.363,0L31.861,13.072
