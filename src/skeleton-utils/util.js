...
export const getHeight = (() => {
  ...
  return function (object) {
    ...
    return getEyePosition(modelBones).sub(
...
export const getModelBones = (object) => {
  ...
  const _findHand = (shoulderBone) =>
    _findClosestChildBone(shoulderBone, (bone) =>
      /hand|wrist/i.test(bone.name)
    );
...
export const getMapBonesForMixamoAnimRetarget = (humanBones) => {
  const optionBones = {
    // orig anim hips name
    hip: 'mixamorigHips',

    // left is vrm/glb bone names and right mixamo fbx bone names
    names: {
      [humanBones.hips.node.name]: 'mixamorigHips',
      [humanBones.spine.node.name]: 'mixamorigSpine1',
      [humanBones.chest.node.name]: 'mixamorigSpine2',
      [humanBones.upperChest.node.name]: 'mixamorigSpine3',
      [humanBones.neck.node.name]: 'mixamorigNeck',
      [humanBones.head.node.name]: 'mixamorigHead',

      [humanBones.leftShoulder.node.name]: 'mixamorigLeftShoulder',
      [humanBones.leftUpperArm.node.name]: 'mixamorigLeftArm',
      [humanBones.leftLowerArm.node.name]: 'mixamorigLeftForeArm',
      [humanBones.leftHand.node.name]: 'mixamorigLeftHand',
      ...
      [humanBones.leftIndexIntermediate.node.name]: 'mixamorigLeftHandIndex2',
      [humanBones.leftIndexDistal.node.name]: 'mixamorigLeftHandIndex3',

      //Middle
      [humanBones.leftMiddleProximal.node.name]: 'mixamorigLeftHandMiddle1',
      [humanBones.leftMiddleIntermediate.node.name]: 'mixamorigLeftHandMiddle2',
      [humanBones.leftMiddleDistal.node.name]: 'mixamorigLeftHandMiddle3',

      //Ring
      [humanBones.leftRingProximal.node.name]: 'mixamorigLeftHandRing1',
      [humanBones.leftRingIntermediate.node.name]: 'mixamorigLeftHandRing2',
      [humanBones.leftRingDistal.node.name]: 'mixamorigLeftHandRing3',

      //Little
      [humanBones.leftLittleProximal.node.name]: 'mixamorigLeftHandRing1',
      [humanBones.leftLittleIntermediate.node.name]: 'mixamorigLeftHandRing2',
      [humanBones.leftLittleDistal.node.name]: 'mixamorigLeftHandRing3',

      [humanBones.rightShoulder.node.name]: 'mixamorigRightShoulder',
      [humanBones.rightUpperArm.node.name]: 'mixamorigRightArm',
      [humanBones.rightLowerArm.node.name]: 'mixamorigRightForeArm',
      [humanBones.rightHand.node.name]: 'mixamorigRightHand',
      ...
      [humanBones.rightIndexIntermediate.node.name]: 'mixamorigRightHandIndex2',
      [humanBones.rightIndexDistal.node.name]: 'mixamorigRightHandIndex3',

      //Middle
      [humanBones.rightMiddleProximal.node.name]: 'mixamorigRightHandMiddle1',
      [humanBones.rightMiddleIntermediate.node.name]:
        'mixamorigRightHandMiddle2',
      [humanBones.rightMiddleDistal.node.name]: 'mixamorigRightHandMiddle3',

      //Ring
      [humanBones.rightRingProximal.node.name]: 'mixamorigRightHandRing1',
      [humanBones.rightRingIntermediate.node.name]: 'mixamorigRightHandRing2',
      [humanBones.rightRingDistal.node.name]: 'mixamorigRightHandRing3',

      //Little
      [humanBones.rightLittleProximal.node.name]: 'mixamorigRightHandRing1',
      [humanBones.rightLittleIntermediate.node.name]: 'mixamorigRightHandRing2',
      [humanBones.rightLittleDistal.node.name]: 'mixamorigRightHandRing3',

      [humanBones.leftUpperLeg.node.name]: 'mixamorigLeftUpLeg',
      [humanBones.leftLowerLeg.node.name]: 'mixamorigLeftLeg',
      [humanBones.leftFoot.node.name]: 'mixamorigLeftFoot',

      [humanBones.rightUpperLeg.node.name]: 'mixamorigRightUpLeg',
      [humanBones.rightLowerLeg.node.name]: 'mixamorigRightLeg',
      [humanBones.rightFoot.node.name]: 'mixamoRightFoot'
    }
  };
  return optionBones;
};
